...
var RUN_TYPES = ['navigate', 'set_var', 'store', 'agent_prompt', 'agent_command', 'effect', 'dictation'];
...
var ITEM_FIELD_DEFS = [
  ...
  { id: 'run.variable', type: 'text', required: false, maxLen: constants.MAX_ACTION_ID_LEN },
...
module.exports = {
  schemaVersion: constants.SDUI_SCHEMA_VERSION_V1_2_0,
  enums: {
